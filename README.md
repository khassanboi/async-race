...
You can use an already deployed online page through the link below:
...
Alternatively, below is the step by step instructions to install and run the app locally in your machine:
